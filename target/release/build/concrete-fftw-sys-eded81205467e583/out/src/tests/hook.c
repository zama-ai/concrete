/* concrete-fftw hook to be used in the benchmark program.
   ...
   2) this code is a royal mess.  The messiness is due to
      A) confusion between internal concrete-fftw tensors and bench_tensor's
...
/*
  transform an concrete-fftw tensor into a bench_tensor.
*/
...
/*
  transform an concrete-fftw problem into a bench_problem.
*/
