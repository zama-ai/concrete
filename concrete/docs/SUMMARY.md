...
* [Parity Bit (Boolean)](tutorials/parity\_bit.md)
* [FheLatinString (Integers)](tutorials/latin\_string.md)

## How to

* [Serialization](how_to/serialization.md)
* [Client Server](how_to/client\_server.md)
* [Debugging](how\_to/debuging.md)
* [Performances](how\_to/performances.md)
