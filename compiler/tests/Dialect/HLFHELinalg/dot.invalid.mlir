...
{
  // expected-error @+1 {{'HLFHELinalg.dot_eint_int' op arguments have incompatible shapes}}
...
{
  // expected-error @+1 {{'HLFHELinalg.dot_eint_int' op operand #1 must}}
  %ret = "HLFHELinalg.dot_eint_int"(%arg0, %arg1) :
...
{
  // expected-error @+1 {{'HLFHELinalg.dot_eint_int' op operand #0}}
  %ret = "HLFHELinalg.dot_eint_int"(%arg0, %arg1) :
...
{
  // expected-error @+1 {{'HLFHELinalg.dot_eint_int' op  should have the width of encrypted inputs and result equals}}
  %ret = "HLFHELinalg.dot_eint_int"(%arg0, %arg1) :
...
{
  // expected-error @+1 {{'HLFHELinalg.dot_eint_int' op  should have the width of plain input equals to width of encrypted input + 1}}
  %ret = "HLFHELinalg.dot_eint_int"(%arg0, %arg1) :
