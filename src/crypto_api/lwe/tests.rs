...
fn test_encode_encrypt_x_add_x_decrypt() {
    ...
    for _ in 0..100 {
        ...
        // encode and encrypt
        let ciphertext_1 =
            crypto_api::LWE::encode_encrypt(&secret_key, message_1, &encoder).unwrap();
        let ciphertext_2 =
            crypto_api::LWE::encode_encrypt(&secret_key, message_2, &encoder2).unwrap();
...
fn test_encode_encrypt_x_opposite_inplace_x_decrypt() {
    ...
    for _ in 0..100 {
        ...
        // encode and encrypt
        let mut ciphertext =
            crypto_api::LWE::encode_encrypt(&secret_key, message, &encoder).unwrap();
...
fn test_encode_encrypt_x_add_centered_inplace_x_decrypt() {
    ...
    for _ in 0..200 {
        ...
        let ciphertext2 =
            crypto_api::LWE::encode_encrypt(&secret_key, message2, &encoder2).unwrap();
...
fn test_encode_encrypt_x_sub_with_padding_exact_inplace_x_decrypt() {
    ...
    // encoders
    let encoder1 =
        crypto_api::Encoder::new_rounding_context(min1, max1, precision, padding).unwrap();
    let encoder2 =
        crypto_api::Encoder::new_rounding_context(min2, max2, precision, padding).unwrap();
...
fn test_encode_encrypt_x_mul_constant_static_encoder_inplace_x_decrypt() {
    ...
    for _ in 0..100 {
        ...
        // encode and encrypt
        let mut ciphertext =
            crypto_api::LWE::encode_encrypt(&secret_key, message1, &encoder).unwrap();
...
fn test_encode_encrypt_x_add_with_new_min_inplace_x_decrypt() {
    ...
    for _ in 0..100 {
        ...
        let ciphertext_2 =
            crypto_api::LWE::encode_encrypt(&secret_key, message_2, &encoder_2).unwrap();
