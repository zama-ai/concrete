...
impl Plaintext {
    ...
    pub fn zero(nb_plaintexts: usize) -> Plaintext {
        Plaintext {
            encoders: vec![crypto_api::Encoder::zero(); nb_plaintexts],
    ...
    ) -> Result<Plaintext, CryptoAPIError> {
    ...
    /// ```
    pub fn set_encoders(&mut self, encoders: &[crypto_api::Encoder]) {
        debug_assert!(
    ...
    /// ```
    pub fn set_encoders_from_one(&mut self, encoder: &crypto_api::Encoder) {
    ...
    /// ```
    pub fn set_nth_encoder(&mut self, nth: usize, encoder: &crypto_api::Encoder) {
