...
pub trait PolynomialTensor: Sized {
    ...
    fn named_print(poly: &[Self], polynomial_size: usize, name: std::string::String);
        ...
        impl PolynomialTensor for $T {
            ...
            fn compute_binary_multisum_monome(
                ...
                for i in 0..polynomial_size {
                    ...
                    if monomial < i {
                        pow_key = pow_key + polynomial_size;
                    }
                    pow_key = pow_key - i;
            ...
            fn multiply_by_monomial(
                ...
                if n_rotation > polynomial_size {
                    n_rotation = n_rotation - polynomial_size;
            ...
            /// Prints in a pretty way a tensor of polynomials over the Torus with a name before
            ...
            /// ```
            fn named_print(poly: &[$T], polynomial_size: usize, name: std::string::String) {
                print!("[{}] poly:", name);
                let s = Self::to_string_(poly, polynomial_size);
                println!("{}", s.replace("{}", " "));
            }
...
fn convert_to_index(polynomial_size: usize, mask_index: usize, monomial_index: usize) -> usize {
    return mask_index * polynomial_size + monomial_index;
}
