...
macro_rules! assert_noise_distribution {
    ($messages:expr, $new_messages: expr, $variance:expr, $op_name:expr) => {
        use crate::operators::math::random::{vectorial_openssl_float_normal};
...
macro_rules! TWIDDLES_TORUS {
    ($degree:expr) => {
        match $degree {
            512 => &crate::operators::math::twiddles::TWIDDLES_512_C64[..],
            1024 => &crate::operators::math::twiddles::TWIDDLES_1024_C64[..],
            2048 => &crate::operators::math::twiddles::TWIDDLES_2048_C64[..],
...
macro_rules! TWIDDLES_TORUS_external {
    ($degree:expr) => {
        match $degree {
            512 => &concrete_lib::operators::math::twiddles::TWIDDLES_512_C64[..],
            1024 => &concrete_lib::operators::math::twiddles::TWIDDLES_1024_C64[..],
            2048 => &concrete_lib::operators::math::twiddles::TWIDDLES_2048_C64[..],
            _ => panic!("Degree {} is not yet supported", $degree),
        }
    };
}
macro_rules! INVERSE_TWIDDLES_TORUS {
    ($degree:expr) => {
        match $degree {
            512 => &crate::operators::math::twiddles::INVERSE_TWIDDLES_512_C64[..],
            1024 => &crate::operators::math::twiddles::INVERSE_TWIDDLES_1024_C64[..],
            2048 => &crate::operators::math::twiddles::INVERSE_TWIDDLES_2048_C64[..],
            _ => panic!("Degree {} is not yet supported", $degree),
        }
    };
}
...
macro_rules! INVERSE_TWIDDLES_TORUS_external {
    ($degree:expr) => {
        match $degree {
            512 => &concrete_lib::operators::math::twiddles::INVERSE_TWIDDLES_512_C64[..],
            1024 => &concrete_lib::operators::math::twiddles::INVERSE_TWIDDLES_1024_C64[..],
            2048 => &concrete_lib::operators::math::twiddles::INVERSE_TWIDDLES_2048_C64[..],
            _ => panic!("Degree {} is not yet supported", $degree),
        }
    };
}
