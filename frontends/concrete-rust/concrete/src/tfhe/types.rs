    ...
    use quote::{quote, ToTokens};
        ...
        impl ToTokens for EncryptionKeyChoice {
            fn to_tokens(&self, tokens: &mut TokenStream) {
                match self{
                    EncryptionKeyChoice::BIG => tokens.extend(quote! {::concrete::tfhe::EncryptionKeyChoice::BIG}),
                    EncryptionKeyChoice::SMALL => tokens.extend(quote! {::concrete::tfhe::EncryptionKeyChoice::SMALL}),
                }
            }
        }
