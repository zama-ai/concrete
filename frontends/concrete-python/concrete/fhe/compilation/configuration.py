...
class SynthesisConfig:
    ...
    """
    Enable synthesis for TLU starting at the given input precision, but keep the original TLU when it's faster.
    Used to make high precision TLU faster by rewritting them with several lower precisions TLU.
    """

    force_tlu_at_precision: int = 17
    """
    Force synthesis for TLU starting at the given input precision, even if it's slower than the original TLU.
    ...
    def __init__(
        ...
        *,
        ...
        self.synthesis_config = (
            synthesis_config or SynthesisConfig()
        )
