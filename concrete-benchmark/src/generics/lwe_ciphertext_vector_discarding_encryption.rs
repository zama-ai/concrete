...
use concrete_core::specification::engines::LweCiphertextVectorDiscardingEncryptionEngine;
use criterion::{black_box, BenchmarkId, Criterion};

/// A generic function benchmarking the discarding lwe vector encryption operation.
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                let mut output = CiphertextVector::synthesize(
                    &mut synthesizer,
                    lwe_dim,
                    ciphertext_count,
                    VARIANCE,
                ...
                b.iter(|| {
                    engine
                        .discard_encrypt_lwe_ciphertext_vector(
