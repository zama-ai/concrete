...
use concrete_core::specification::engines::LweCiphertextDiscardingEncryptionEngine;
use criterion::{black_box, BenchmarkId, Criterion};

/// A generic function benchmarking the discarding lwe encryption operation.
    ...
    for param in PARAMETERS {
        group.bench_with_input(
            ...
            |b, param| {
                ...
                let mut ciphertext = Ciphertext::synthesize(&mut synthesizer, lwe_dim, VARIANCE);
                b.iter(|| {
                    engine
                        .discard_encrypt_lwe_ciphertext(
