...
public:
  ...
  static Result<ClientProgram> create(const concreteprotocol::ProgramInfo &info, const ClientKeyset &keyset, std::shared_ptr<EncryptionCSPRNG> csprng, bool useSimulation = false);
