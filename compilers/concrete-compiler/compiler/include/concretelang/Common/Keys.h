...
public:
  ...
  const Message<concreteprotocol::LweSecretKeyInfo> &getInfo();
...
public:
  ...
  const Message<concreteprotocol::LweBootstrapKeyInfo> &getInfo();
...
public:
  ...
  const Message<concreteprotocol::LweKeyswitchKeyInfo> &getInfo();
...
public:
  ...
  const Message<concreteprotocol::PackingKeyswitchKeyInfo> &getInfo();
