module attributes {
    glwe.test = #glwe.expr<( @new_q div 2.0 ) ** 2.>,
    glwe.test2 = #glwe.expr<((@n * ((@q ** 2. div (96.0 * ( @new_q div 2.0 ) ** 2.)) + 1.0 div 48.0)) div @q**2.0) + @input_variance>,
    // glwe.pred = #glwe.expr<@a + @b * @c>,
    // glwe.pred2 = #glwe.expr<@a * @b + @c>
    // ,
