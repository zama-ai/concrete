...
namespace clientlib {
   ...
   Result<ClientCircuit> ClientCircuit::create(const concreteprotocol::CircuitInfo &info,
                                      ...
                                      std::shared_ptr<EncryptionCSPRNG> csprng,
                                      bool useSimulation) {
  ...
  Result<ClientProgram> ClientProgram::create(const concreteprotocol::ProgramInfo &info, const ClientKeyset &keyset, std::shared_ptr<EncryptionCSPRNG> csprng, bool useSimulation){
