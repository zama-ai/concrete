...
#[allow(unused)]
pub fn inp(partition: PartitionIndex) -> Symbol {
    Symbol::Input(partition)
}

/// Returns an keyswitch symbol.
#[allow(unused)]
pub fn ks(from: PartitionIndex, to: PartitionIndex) -> Symbol {
    Symbol::Keyswitch(from, to)
}

/// Returns a fast keyswitch symbol.
#[allow(unused)]
pub fn fks(from: PartitionIndex, to: PartitionIndex) -> Symbol {
    Symbol::FastKeyswitch(from, to)
}

/// Returns a pbs symbol.
#[allow(unused)]
pub fn pbs(partition: PartitionIndex) -> Symbol {
    Symbol::Bootstrap(partition)
}

/// Returns a modulus switch symbol.
#[allow(unused)]
pub fn ms(partition: PartitionIndex) -> Symbol {
    Symbol::Bootstrap(partition)
}
