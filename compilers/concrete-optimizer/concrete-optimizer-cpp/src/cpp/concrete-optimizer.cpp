...
struct DagBuilder final : public ::rust::Opaque {
  ...
  ::concrete_optimizer::dag::OperatorIndex add_zero(::std::uint8_t out_precision, ::rust::Slice<::std::uint64_t const> out_shape, ::concrete_optimizer::Location const &location) noexcept;
  ...
  ::concrete_optimizer::dag::OperatorIndex add_max(::rust::Slice<::concrete_optimizer::dag::OperatorIndex const> inputs, ::rust::Slice<::std::uint64_t const> out_shape, ::concrete_optimizer::Location const &location) noexcept;
...
::concrete_optimizer::dag::OperatorIndex concrete_optimizer$cxxbridge1$DagBuilder$add_zero(::concrete_optimizer::DagBuilder &self, ::std::uint8_t out_precision, ::rust::Slice<::std::uint64_t const> out_shape, ::concrete_optimizer::Location const &location) noexcept;
...
::concrete_optimizer::dag::OperatorIndex concrete_optimizer$cxxbridge1$DagBuilder$add_max(::concrete_optimizer::DagBuilder &self, ::rust::Slice<::concrete_optimizer::dag::OperatorIndex const> inputs, ::rust::Slice<::std::uint64_t const> out_shape, ::concrete_optimizer::Location const &location) noexcept;
...
::concrete_optimizer::dag::OperatorIndex DagBuilder::add_zero(::std::uint8_t out_precision, ::rust::Slice<::std::uint64_t const> out_shape, ::concrete_optimizer::Location const &location) noexcept {
  return concrete_optimizer$cxxbridge1$DagBuilder$add_zero(*this, out_precision, out_shape, location);
}
...
::concrete_optimizer::dag::OperatorIndex DagBuilder::add_max(::rust::Slice<::concrete_optimizer::dag::OperatorIndex const> inputs, ::rust::Slice<::std::uint64_t const> out_shape, ::concrete_optimizer::Location const &location) noexcept {
  return concrete_optimizer$cxxbridge1$DagBuilder$add_max(*this, inputs, out_shape, location);
}
