...
/// A fixture for the types implementing the `LweCiphertextVectorFusingAdditionEngine`
/// trait.
pub struct LweCiphertextVectorFusingAdditionFixture;

#[derive(Debug)]
pub struct LweCiphertextVectorFusingAdditionParameters {
...
impl<Precision, Engine, InputCiphertextVector, OutputCiphertextVector>
    ...
    for LweCiphertextVectorFusingAdditionFixture
where
    Precision: IntegerPrecision,
    Engine: LweCiphertextVectorFusingAdditionEngine<InputCiphertextVector, OutputCiphertextVector>,
...
{
    type Parameters = LweCiphertextVectorFusingAdditionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextVectorFusingAdditionParameters {
    ...
    fn execute_engine(
        ...
        unsafe {
            engine.fuse_add_lwe_ciphertext_vector_unchecked(
