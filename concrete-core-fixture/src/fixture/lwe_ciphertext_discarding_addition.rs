...
/// A fixture for the types implementing the `LweCiphertextDiscardingAdditionEngine`
/// trait.
pub struct LweCiphertextDiscardingAdditionFixture;

#[derive(Debug)]
pub struct LweCiphertextDiscardingAdditionParameters {
    pub noise: Variance,
...
impl<Precision, Engine, InputCiphertext, OutputCiphertext>
    ...
    for LweCiphertextDiscardingAdditionFixture
where
...
{
    type Parameters = LweCiphertextDiscardingAdditionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![LweCiphertextDiscardingAdditionParameters {
    ...
    fn execute_engine(
        ...
        unsafe {
            engine.discard_add_lwe_ciphertext_unchecked(
