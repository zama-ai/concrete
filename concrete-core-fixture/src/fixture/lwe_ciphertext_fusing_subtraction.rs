...
/// trait.
pub struct LweCiphertextFusingSubtractionFixture;

#[derive(Debug)]
pub struct LweCiphertextFusingSubtractionParameters {
    pub noise: Variance,
...
impl<Precision, Engine, InputCiphertext, OutputCiphertext>
    ...
    for LweCiphertextFusingSubtractionFixture
where
    Precision: IntegerPrecision,
    Engine: LweCiphertextFusingSubtractionEngine<InputCiphertext, OutputCiphertext>,
...
{
    type Parameters = LweCiphertextFusingSubtractionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![LweCiphertextFusingSubtractionParameters {
    ...
    fn execute_engine(
        ...
        unsafe {
            engine.fuse_sub_lwe_ciphertext_unchecked(&mut output_ciphertext, &input_ciphertext)
        };
