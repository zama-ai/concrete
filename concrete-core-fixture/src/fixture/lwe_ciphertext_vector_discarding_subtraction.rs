...
/// A fixture for the types implementing the `LweCiphertextVectorDiscardingSubtractionEngine`
/// trait.
pub struct LweCiphertextVectorDiscardingSubtractionFixture;

#[derive(Debug)]
pub struct LweCiphertextVectorDiscardingSubtractionParameters {
...
impl<Precision, Engine, InputCiphertextVector, OutputCiphertextVector>
    ...
    for LweCiphertextVectorDiscardingSubtractionFixture
where
    Precision: IntegerPrecision,
    Engine: LweCiphertextVectorDiscardingSubtractionEngine<
...
{
    type Parameters = LweCiphertextVectorDiscardingSubtractionParameters;
    ...
    fn generate_parameters_iterator() -> Box<dyn Iterator<Item = Self::Parameters>> {
        Box::new(
            vec![
                LweCiphertextVectorDiscardingSubtractionParameters {
    ...
    fn execute_engine(
        ...
        let (input_ciphertext_vector1, input_ciphertext_vector2, mut output_ciphertext_vector) =
            context;
        unsafe {
            engine.discard_sub_lwe_ciphertext_vector_unchecked(
