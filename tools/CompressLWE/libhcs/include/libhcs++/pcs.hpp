...
public:
  ...
  ~public_key() { pcs_free_public_key(pk); }

  pcs_public_key *as_ptr() { return pk; }
  ...
  void clear() { pcs_clear_public_key(pk); }

  std::string export_json() { return std::string(pcs_export_public_key(pk)); }
...
public:
  ...
  ~private_key() { pcs_free_private_key(vk); }

  pcs_private_key *as_ptr() { return vk; }
  ...
  void clear() { pcs_clear_private_key(vk); }

  std::string export_json() { return std::string(pcs_export_private_key(vk)); }
