# Concrete Boolean's documentation


## User Guide

* [Introduction](user/introduction.md)
   * [How does it work?](user/how_does_it_work.md)
   * [Tutorila](user/tutorial.md)
   ...
   * [Probability of Error](user/error.md)
* Advanced Topics
   * [Generate Keys](user/advanced_topics/index)
   * [Save / Load](user/advanced_topics/index)
