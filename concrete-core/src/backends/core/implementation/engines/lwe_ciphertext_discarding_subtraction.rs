...
/// # Description:
/// Implementation of [`LweCiphertextDiscardingSubtractionEngine`] for [`CoreEngine`] that operates
/// on 32 bits integers.
impl LweCiphertextDiscardingSubtractionEngine<LweCiphertext32, LweCiphertext32> for CoreEngine {
    /// # Example:
    /// ```
...
/// Implementation of [`LweCiphertextDiscardingSubtractionEngine`] for [`CoreEngine`] that operates
/// on 64 bits integers.
impl LweCiphertextDiscardingSubtractionEngine<LweCiphertext64, LweCiphertext64> for CoreEngine {
    /// # Example:
    /// ```
    /// use concrete_commons::dispersion::Variance;
    /// use concrete_commons::parameters::LweDimension;
