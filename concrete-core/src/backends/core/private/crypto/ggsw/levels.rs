...
impl<Cont> GgswLevelMatrix<Cont> {
    ...
    /// ```rust
    /// use concrete_commons::parameters::{GlweSize, PolynomialSize};
    /// use concrete_core::backends::core::private::crypto::ggsw::GgswLevelMatrix;
    /// use concrete_core::backends::core::private::math::decomposition::DecompositionLevel;
...
impl<Cont> GgswLevelRow<Cont> {
    ...
    /// ```rust
    /// use concrete_commons::parameters::{GlweSize, PolynomialSize};
    /// use concrete_core::backends::core::private::crypto::ggsw::GgswLevelRow;
    /// use concrete_core::backends::core::private::math::decomposition::DecompositionLevel;
