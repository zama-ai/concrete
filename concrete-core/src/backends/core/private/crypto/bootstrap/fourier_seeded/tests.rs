...
use crate::backends::core::private::crypto::bootstrap::{
    FourierBootstrapKey, FourierBuffers, StandardBootstrapKey, StandardSeededBootstrapKey,
};
...
fn test_fourier_seeded_bootstrap<T: UnsignedTorus>() {
    ...
    coef_bsk_seeded.fill_with_new_key(&lwe_sk, &glwe_sk, noise_parameters, seed);
