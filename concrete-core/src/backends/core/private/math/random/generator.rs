...
#[cfg(feature = "multithread")]
pub use concrete_csprng::generators::ParallelRandomGenerator as PrngParallelRandomGenerator;
pub use concrete_csprng::generators::RandomGenerator as PrngRandomGenerator;
...
/// let UNSAFE_SEED = Seed(0);
/// let mut generator = RandomGenerator::new(UNSAFE_SEED);
...
pub struct RandomGenerator<G: PrngRandomGenerator>(G);

impl<G: PrngRandomGenerator> RandomGenerator<G> {
    ...
    pub fn is_bounded(&self) -> bool {
        self.0.remaining_bytes().0 < u128::MAX
    }
...
#[cfg(feature = "multithread")]
impl<G: PrngParallelRandomGenerator> RandomGenerator<G> {
    /// Tries to fork the current generator into `n_child` generator bounded to `bytes_per_child`,
    ...
    pub fn par_try_fork(
        ...
        n_child: usize,
        bytes_per_child: usize,
    ) -> Option<impl IndexedParallelIterator<Item = RandomGenerator<G>>> {
        self.0
